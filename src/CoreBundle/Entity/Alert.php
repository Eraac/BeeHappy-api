...
class Alert implements OwnableInterface
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="CoreBundle\Entity\Hive", inversedBy="alerts")
     * @JMS\Expose()
    ...
    {
        $this->hives  = new \Doctrine\Common\Collections\ArrayCollection();
    }
     ...
     * @return Alert
     */
    public function addHive(\CoreBundle\Entity\Hive $hive)
    {
        $this->hives[] = $hive;
     ...
     * @param \CoreBundle\Entity\Hive $hive
     */
    public function removeHive(\CoreBundle\Entity\Hive $hive)
    {
